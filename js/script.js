...
$('form').on('submit', (event) =>{
    ...
    //openweathermap current weather api
            url: `${proxy}api.openweathermap.org/data/2.5/weather?appid=81fc1487f09e04dba61c57f2c8c3a3ef&q=${userInput}&units=imperial&zip=${userInput}`,
    ...
    //openweathermap 5 day weather forecast api
        url: `${proxy}api.openweathermap.org/data/2.5/forecast?appid=81fc1487f09e04dba61c57f2c8c3a3ef&q=${userInput}&units=imperial&zip=${userInput}`
